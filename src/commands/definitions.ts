...
export function buildCommands(options: CommandBuildOptions = {}) {
  ...
  const commands = [
    new SlashCommandBuilder()
      ...
      .addChannelOption((option) => textChannelOption(option, "logban_channel", "Existing ban log channel."))
  ...
  return new SlashCommandBuilder()
    ...
    .addSubcommand((sub) =>
      sub
        ...
        .addChannelOption((option) => textChannelOption(option, "quota", "Quota alerts/status channel."))
        ...
        .addChannelOption((option) => textChannelOption(option, "logban", "Ban log channel."))
