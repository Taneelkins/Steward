...
const helpCommands: HelpCommand[] = [
  ...
  },
  {
    ...
    notes: [
      ...
      "**Requires Datastore API key permissions** — the API key saved via `/roblox` must have **Universe Datastore Objects → Read** and **Universe Datastore Objects → Update** enabled, scoped to your universe. See `/help` → Admin → Roblox Game Setup for the full API key setup guide.",
